...
#define LCD_RST1  HAL_GPIO_WritePin(GPIOC, LCD_RST_Pin,GPIO_PIN_SET);
#define LCD_RST0  HAL_GPIO_WritePin(GPIOC, LCD_RST_Pin,GPIO_PIN_RESET);
...
#define	LCD_DC1	HAL_GPIO_WritePin(GPIOA, LCD_RS_Pin,GPIO_PIN_SET)
#define	LCD_DC0 HAL_GPIO_WritePin(GPIOA, LCD_RS_Pin,GPIO_PIN_RESET)
